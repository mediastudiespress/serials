...
\noindent\LARGE{Maria Löblich}\par}\marginnote{\emph{Maria Löblich and Niklas Venema, ``West Berlin's Critical Communication Studies and the Cold War: A Study on Symbolic Power from 1948 to 1989,'' \emph{History of Media Studies} 2 (2022), \href{https://doi.org/10.32376/d895a0ea.d0db9590}{https://doi.org/ 10.32376/d895a0ea.d0db9590}.} \vspace*{0.75em}}
\vspace*{0.5em}
...
globe,''\textsuperscript{22} but they nevertheless\marginnote{\textsuperscript{20} Risso, ``Radio Wars.''} seemed\marginnote{\textsuperscript{21} Marko Ampuja, ``Four Moments of International
  ...
  Steve Jones (New York: Hampton Press, 2012), 107--20.} to\marginnote{\textsuperscript{22}\setcounter{footnote}{22} Cmiel, ``Cynicism, Evil, and the Discovery of
  Communication,'' 95.} have created a
...
mass media,
\newpage 
\noindent he\marginnote{\textsuperscript{62} Fritz Eberhard,
...
professors, repeatedly engaged in Berlin book reviews, criticized\marginnote{1973); Autorenkollektiv Presse, \emph{Wie links
...
``ideological\marginnote{\textsuperscript{117} Wolf Bauer, Elke Baur, and Bernd Kungel, \emph{Vier
  ...
  Luchterhand, 1973).} which\marginnote{\textsuperscript{119} Hanno Beth and Harry Pross, \emph{Einführung in die
  Kommunikationswissenschaft} (Stuttgart: Kohlhammer, 1976).} they\marginnote{\textsuperscript{120}\setcounter{footnote}{120} Löblich and Venema,
  ``\,`Regierungszeit des Mittelbaus'? Eine Einführung.''} identified in the application of a
...
\newpage 
\noindent i\marginnote{\textsuperscript{125} Abgeordnetenhaus
  von Berlin, minutes of July 6, 1978.}n\marginnote{\textsuperscript{126} Maria Löblich, ``Eine `grundlegende Neugestaltung': Die
  ...
  Annäherungen an die Berliner Publizistikwissenschaft nach der
  Studentenbewegung}, eds. Maria Löblich and Niklas Venema (Cologne:
  Halem, 2020).}s\marginnote{\textsuperscript{127} Abgeordnetenhaus von
  Berlin, minutes of June 24 1976, 1277.}t\marginnote{\textsuperscript{128} Abgeordnetenhaus von Berlin, minutes of July 6,
  1978, 3936, 3940.}i\marginnote{\textsuperscript{129} Abgeordnetenhaus von
  Berlin, minutes of July 6, 1978, 3937.}t\marginnote{\textsuperscript{130}\setcounter{footnote}{130} Nikolai Wehrs, \emph{Protest der Professoren: Der
