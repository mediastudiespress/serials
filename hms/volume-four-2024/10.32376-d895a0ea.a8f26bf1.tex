...
\newthought{This special section} investigates the history of communication and media
...
criticize its application.\textsuperscript{17} ``Is it possible, even
...
future, but worries\marginnote{\textsuperscript{15} Maria Immacolata Vassallo De Lopes and Raúl
  ...
  comunicación:} that a ``generalizing project'' centered on the
...
perversions---silences and warpings---of the neoliberal\newpage\noindent ``world academic\marginnote{Algunas notas críticas y una propuesta,''
  ...
  their English titles included above.}
system''\marginnote{\textsuperscript{16} See, for example, Colón
  ...
  ``Estudios de comunicación desde el pensamiento caribeño.''} over\marginnote{\textsuperscript{20} In the Caribbean context, two important
  ...
  investigación en comunicación.''} the\marginnote{\textsuperscript{21} That many papers in both
  ...
  academy---a theme addressed in a number of the collections' articles.} last\marginnote{\textsuperscript{22} The authors based outside Latin America are
  ...
  Americas.''} three decades.\textsuperscript{30} Here again the US is implicated---as
...
special section chart\marginnote{\textsuperscript{23} Vassallo de Lopes and Fuentes Navarro, in
  ...
  campo de estudos da comunicação,'' 9.} numerous\marginnote{\textsuperscript{24} In the prose that follows, ``we'' refers
  ...
  and Rüdiger, ``Adeus à crítica?''} to\marginnote{\textsuperscript{28} See Averbeck-Lietz, ``On (Missing) Links
  between German, Latin American, and French Mediatization Research,''
  259--62; Rüdiger, ``Adeus à crítica?''; and Waisbord, ``¿Cómo
  enfrentar las desigualdades de la academia global en los estudios de
  comunicación?'' 296--99.} describe\marginnote{\textsuperscript{29} Waisbord, ``¿Cómo enfrentar las
  ...
  ``América Latina, internacionalização e reciprocidade acadêmica.''} and consider
their topics.
...
eleven\marginnote{\textsuperscript{30} Arroyave,
  ...
  los estudios de comunicación?''} countries\marginnote{\textsuperscript{31} Simonson, Pooley, and Park, ``The History of
